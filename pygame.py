...
def mover(figura, dim_janela):
    ...
    relogio = pygame.time.pygame.time.Clock()

    janela = pygame.display.set_mode((LARGURAJANELA, ALTURAJANELA))
    pygame.display.set_caption('colisão')
    b1 = {'objRect' : pygame.Rect(375, 80, 40, 40), 'cor': VEMELHO, 'vel': [0, 2]}
    ...
    bola = {'objRect' : pygame.Rect(75, 150, 40, 40), 'cor' :BRANCO, 'vel' : [3, 3]}
    deve_continuar = True
